...
<script>
	...
	function sendInfo() {
		...
		var url = "http://BLRPRGFWD31240:8082/ProjectCart4/checkAvailability?id=" + id+"&pname="+pname+"&price="+price+"&quantity="+quantity;
...
<center><h2>Product Information</h2></center>
      <p></p>
      <p></p>
<form name="product" action = "http://BLRPRGFWD31240:8082/ProjectCart4/add">
	<table align="center">
		<tr>
			<td></td>
		...
		<tr>
			<td>Price</td>
			<td><input type="text" name="price" value="50000"></td>
		</tr>
		<tr>
			<td>Quantity</td>
			<td><input type="text"  name="quantity" placeholder="Enter quantity" required="required"></td><td class="avail"><span id="availability"> </span> </td>
